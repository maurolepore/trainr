...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/trainr)](https://CRAN.R-project.org/package=trainr)
<!-- badges: end -->
...
be tedious (e.g. label unlabelled code chunks and chain exercises setup). This
